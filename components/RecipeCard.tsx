  ...
  return (
    ...
    >
      ...
      <div className="px-4 pt-4 pb-2 flex-1">
        ...
        <h2 className="mt-2.5 text-base font-[var(--font-playfair)] font-bold text-stone-900 group-hover:text-green-700 transition-colors leading-snug flex items-center gap-1.5">
          {recipe.name}
          {recipe.url && (
